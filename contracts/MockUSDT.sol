...
contract MockUSDT is ERC20 {
    ...
    /**
     * @dev Utility function to get amount with decimals
     * @param amount Amount in whole numbers (e.g., 100 for 100 USDT)
     * @return Amount with 6 decimals applied
     */
    function toTokenAmount(uint256 amount) external pure returns (uint256) {
        return amount * 10**6;
    }
    
    /**
     * @dev Utility function to get human readable amount
     * @param tokenAmount Amount with decimals
     * @return Human readable amount
     */
    function toHumanAmount(uint256 tokenAmount) external pure returns (uint256) {
        return tokenAmount / 10**6;
    }
}